...
if CLIENT then
    ...
    function TOOL:DrawToolScreen(width, height)
        ...
        draw.SimpleText("State Condition", "DermaLarge",
        width / 2, height * 0.15,
        Color(180, 180, 180),
        TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        
        local keyDisplay = scopeName .. "." .. (key == "" and "?" or key)
        if #keyDisplay > 26 then keyDisplay = string.sub(keyDisplay, 1, 26) .. "..." end
        
        draw.SimpleText(keyDisplay, "DermaDefault",
        width / 2, height * 0.4,
        Color(240, 235, 230),
        TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        ...
        if #detail > 26 then detail = string.sub(detail, 1, 26) .. "..." end
        
        draw.SimpleText(detail, "DermaDefault",
        width / 2, height * 0.6,
        Color(180, 180, 180),
        TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        
        draw.SimpleText("Type: " .. valueType, "DermaDefault",
        width / 2, height * 0.8,
        Color(120, 120, 120),
        TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
